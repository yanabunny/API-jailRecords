...
DEFINE ('DB_USER', 'qian');  //  you should put your username here
DEFINE ('DB_PASSWORD', '1795724'); //  you should put your password (studentID) here
DEFINE ('DB_HOST', 'dany.simmons.edu');
DEFINE ('DB_NAME', '33001sp19_qian'); //  you should put the database name here.
